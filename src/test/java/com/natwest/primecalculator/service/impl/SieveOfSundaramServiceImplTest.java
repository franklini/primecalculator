...
@SpringBootTest
class SieveOfSundaramServiceImplTest extends TestBase {
    ...
    @Test
    void getSieveEnum() {
        final SieveEnum sieveEnum = beansMappedBySieveEnum.get(SieveEnum.SUNDARAM).getSieveEnum();
        assertEquals(SieveEnum.SUNDARAM, sieveEnum);
    }
    ...
    void getPrimeRange(PrimeRange primeRange) {
        final PrimeRange result = beansMappedBySieveEnum.get(SieveEnum.SUNDARAM).getPrimeRange (primeRange.initial());
