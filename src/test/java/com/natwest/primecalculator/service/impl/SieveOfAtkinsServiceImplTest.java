...
@SpringBootTest
class SieveOfAtkinsServiceImplTest extends TestBase {
    ...
    @Test
    void getSieveEnum() {
        final SieveEnum sieveEnum = beansMappedBySieveEnum.get(SieveEnum.ATKIN).getSieveEnum();
        assertEquals(SieveEnum.ATKIN, sieveEnum);
    }
